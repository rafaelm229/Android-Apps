package com.example.listadeitems.Adapter
...
import com.example.listadeitems.R
import com.example.listadeitems.model.Live
import kotlinx.android.synthetic.main.res_item_layout.view.*
...
class LiveAdapter(private val onItemClicked: (Live) -> Unit): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return LiveViewHolder(
            LayoutInflater.from(parent.context).inflate(R.layout.res_item_layout,parent,false)
        )
    }
